...
public class ConcurrentListExample {
    ...
    public static void main(String[] args) {
        //List<String> list = new ArrayList<>(); - Works on fail-fast by design
        List<String> list = new CopyOnWriteArrayList<>(); //Works on fail-safe by design based on expectedModCount
        /*
